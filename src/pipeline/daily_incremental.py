...
def run_daily_incremental_pipeline(engine, tickers):
    ...
    print(f"New stock prices shape: {new_prices_df.shape}")
    ...
    print(f"Recomputed stock features shape: {stock_features_df.shape}")
    print(f"Updated stock rankings shape: {stock_rankings_df.shape}")
